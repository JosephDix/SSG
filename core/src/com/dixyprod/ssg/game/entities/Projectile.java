 ...
 */
public abstract class Projectile extends SpaceEntity{
    public Projectile(float xPos, float yPos, float xSpeed, float ySpeed, float maxVelocity, int structureIntegrity,
